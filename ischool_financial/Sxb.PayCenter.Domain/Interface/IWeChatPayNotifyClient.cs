...
namespace Sxb.PayCenter.WechatPay
{
    ...
    public interface IWeChatPayNotifyClient
    {
        ...
        // v2
        Task<T> ExecuteRefundAsync<T>(WeChatPayHeaders headers, string body, WeChatPayOptions options, int type = 0) where T : WeChatPayRefundNotify;
        Task<T> ExecuteRefundAsync<T>(Microsoft.AspNetCore.Http.HttpRequest request, WeChatPayOptions options) where T : WeChatPayRefundNotify;
    }
}
